...
enum HomeMenu {
  ...
  MOBILE_RECHARGE(
      'Top-up', 'assets/ic_mobile_recharge.png', Text(AppText.placeholder)),
  ADD_MONEY(
      'Add Money', 'assets/ic_add_money_normal.png', Text(AppText.placeholder)),

  TRANSFER_MONEY('Transfer', 'assets/ic_transfer_money_normal.png',
      Text(AppText.placeholder)),
  INSURANCE('Insurance', 'assets/ic_insurance.png', Text(AppText.placeholder)),
  NAGAD_MELA(
      'Nagad Mela', 'assets/ic_nagad_mela.png', Text(AppText.placeholder)),

  MERCHANT_PAY(
      'Merchant Pay', 'assets/ic_merchantpay.png', Text(AppText.placeholder)),
  ...
  SHADHIN('Shadhin', 'assets/ic_shadhin_pay_customer.png',
      Text(AppText.placeholder)),
